...
import iconApplication from '../assets/LogoIconApplication.png';
function Page_home(){
  {/* scripts Animation */}
...
ปลายนิ้ว</p>
            ...
            <div className='container-LogoIconApplication'>
              <img src={iconApplication} alt='application_icon' id='application_icon' className='show'></img>
            </div>
          </div>
          </div>
        </div>
